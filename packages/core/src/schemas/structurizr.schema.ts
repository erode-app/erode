...
const StructurizrRelationshipSchema = z
  .object({
    sourceId: z.string(),
...
const StructurizrComponentSchema = z
  .object({
...
const StructurizrContainerSchema = StructurizrComponentSchema.extend({
...
const StructurizrSoftwareSystemSchema = StructurizrContainerSchema.extend({
...
const StructurizrPersonSchema = z
  .object({
    id: z.string().optional(),
    name: z.string().optional(),
    description: z.string().optional(),
