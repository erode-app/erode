...
describe('OpenAIProvider', () => {
  ...
  describe('safety filter handling', () => {
    it('should throw SAFETY_FILTERED on content_filter', async () => {
  ...
  describe('truncation handling', () => {
    it('should throw INVALID_RESPONSE on length', async () => {
      ...
      try {
        ...
        expect(error).toBeInstanceOf(ErodeError);
        expect((error as ErodeError).code).toBe(ErrorCode.INVALID_RESPONSE);
      }
    });
  });
