...
| ------------------- | ------------ | -------------------------------------------------------------- |
| GitHub Actions      | Stable       | [GitHub Actions](/docs/integrations/github-actions/)           |
| GitLab CI           | Experimental | [GitLab CI](/docs/integrations/gitlab-ci/)                     |
| Bitbucket Pipelines | Experimental | [Bitbucket Pipelines](/docs/integrations/bitbucket-pipelines/) |

You can also run Erode on any infrastructure using the [self-hosted](/docs/integrations/self-hosted/) guide.
...
[Get started with GitHub Actions →](/docs/integrations/github-actions/)
...
[Set up GitLab CI →](/docs/integrations/gitlab-ci/)
...
[Set up Bitbucket Pipelines →](/docs/integrations/bitbucket-pipelines/)
...
[Self-hosted guide →](/docs/integrations/self-hosted/)
